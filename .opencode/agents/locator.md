...
- **End (write session-level report)**: Write this run's locator conclusions to `.paa/sessions/{session_id}/locator/{api_name}/{short-title}.md`.
  ...
  - Suggested frontmatter: optional `api`, `category: locator`, `owner: L`, `tags`, `summary`.
